...
#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2024/9/24 12:20
# @Author  : wyq
# @File    : chuansongwang.py
...
class WorkOrder:
    def process_work_order(self, driver):
        ...
        fault_first_level_select.select_by_visible_text('电源及配套故障')
        # 定位到二级故障原因
        ...
        fault_second_level_select.select_by_visible_text('供电局停电导致')
        # 定位到三级故障原因
        ...
        fault_third_level.select_by_visible_text('市电停电')
        # 定位到故障处理措施结果
        ...
        handling_result.select_by_visible_text('市电来电后恢复')
        # 定位到所属区域
