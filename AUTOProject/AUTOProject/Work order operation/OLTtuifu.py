...
class WorkOrder:
    def process_work_order(self, driver):
        ...
        reason_category.select_by_visible_text('数据网')
        # 定位到故障一级原因
        ...
        fault_first_level_select.select_by_visible_text('非本地网维护对端故障')
        # 定位到二级故障原因
        ...
        fault_second_level_select.select_by_visible_text('小交换机故障')
        # 定位到三级故障原因
        ...
        fault_third_level.select_by_visible_text('小交换机停电')
        # 定位到故障处理措施结果
        ...
        handling_result.select_by_visible_text('市电恢复')
        # 定位到所属区域
        ...
        # 输入原因
        reason_summary_input.send_keys("供电局市电来电正常后，告警恢复正常。")
        # 定位到是否存在隐患
